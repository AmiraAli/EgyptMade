                ...
                <tr id="order-<?php echo $order->id; ?>" data-order-id="<?php echo $order->id; ?>">
                    ...
                    <td>
                        ...
                        if (function_exists('pll__')) {
                            $string = pll__('View items');
                        } else {
                            $string = __('View items', 'wcvendors');
                        }
                        $order_actions = array(
                            'view' => array(
                                'class' => 'view-items',
                        ...
                        if (function_exists('pll__')) {
                            $string = pll__('Mark shipped');
                        } else {
                            $string = __('Mark shipped', 'wcvendors');
                        }
                        if ($needs_shipping) {
                        ...
                        if (function_exists('pll__')) {
                            $string = pll__('Shipped');
                        } else {
                            $string = __('Shipped', 'wcvendors');
                        }
                        if ($shipped) {
                            $order_actions['shipped'] = array(
                                'class' => 'mark-shipped',
                        ...
                        if (function_exists('pll__')) {
                            $string = pll__('Tracking');
                        } else {
                            $string = __('Tracking', 'wcvendors');
                        }
                        ...
                        if ($order_actions) {
                            ...
                            foreach ($order_actions as $key => $data) {
                                $output[] = sprintf(
                                        '<a href="%s" id="%s" class="%s">%s</a>', (isset($data['url'])) ? $data['url'] : '#', (isset($data['id'])) ? $data['id'] : $key . '-' . $order->id, (isset($data['class'])) ? $data['class'] : '', $data['content']
                                );
                            }
                            echo implode(' | ', $output);
                        }
        ...
        <?php else : ?>
            ...
            <tr>
                <td colspan="4"
                    ...
                    if (function_exists('pll_e')) {
                             pll_e('You have no orders during this period.');
                        } else {
                            _e('You have no orders during this period.', 'wcvendors');
                        }
                     ?></td>
            </tr>
