	            ...
	            <div class="large-12 columns">
	                ...
	                <div class="product_infos">
						...
						if (function_exists('pll_e')) {
							$viewProduct = pll__('VIEW PRODUCT');
						} else {
							$viewProduct = _e('VIEW PRODUCT', 'woocommerce');
						}
	                	...
	                	<div class="buttons">
		            		...
		            		<a class="view-product button" href="<?php the_permalink(); ?>"><?php esc_html_e( $viewProduct, 'woocommerce') ?></a>
	            		</div>
