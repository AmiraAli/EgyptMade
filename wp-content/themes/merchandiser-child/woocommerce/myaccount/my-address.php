...
if (!wc_ship_to_billing_address_only() && wc_shipping_enabled()) {
	$get_addresses = apply_filters('woocommerce_my_account_get_addresses', array(
		'billing' => __(pll__('Billing Address'), 'woocommerce'),
		'shipping' => __(pll__('Shipping Address'), 'woocommerce')
			), $customer_id);
} else {
	$get_addresses = apply_filters('woocommerce_my_account_get_addresses', array(
		'billing' => __(pll__('Billing Address'), 'woocommerce')
...
<p>
	...
	if (function_exists('pll_e')) {
		...
		echo apply_filters('woocommerce_my_account_my_address_description', __(pll__('The following addresses will be used on the checkout page by default.'), 'woocommerce'));
	} else {
...
<?php foreach ($get_addresses as $name => $title) : ?>
	...
	if (!$formatted_address) {
		if (function_exists('pll_e')) {
			...
			_e(pll__('You have not set up this type of address yet.'), 'woocommerce');
		}
	} else {
